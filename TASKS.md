...
- [~] `P0` Publicar na Vercel e habilitar Analytics e Speed Insights no painel; site publicado em `site-anderson-junior.vercel.app`, com ativação das métricas ainda pendente.
